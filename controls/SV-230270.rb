...
/lib/sysctl.d/*.conf
/etc/sysctl.conf'
  desc 'check', 'Verify RHEL 8 is configured to prevent kernel profiling by nonprivileged users.
...
If "kernel.perf_event_paranoid" is not set to "2" or is missing, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to prevent kernel profiling by nonprivileged users.
