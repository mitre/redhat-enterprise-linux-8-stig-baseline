...
/lib/sysctl.d/*.conf
/etc/sysctl.conf)
  desc 'check', 'Verify RHEL 8 is configured to enable DAC on symlinks.
...
If "fs.protected_symlinks" is not set to "1" or is missing, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to enable DAC on symlinks with the following:
...
$ sudo sysctl --system'
  impact 0.5
  tag check_id: 'C-32936r1184247_chk'
  tag severity: 'medium'
  tag gid: 'V-230267'
  ...
  tag satisfies: ['SRG-OS-000312-GPOS-00122', 'SRG-OS-000312-GPOS-00123', 'SRG-OS-000324-GPOS-00125', 'SRG-OS-000312-GPOS-00124']
  tag 'documentable'
